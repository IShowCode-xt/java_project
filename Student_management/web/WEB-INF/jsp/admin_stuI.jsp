                ...
                <table class="result-tab" width="100%" id ="vetListTable">
                    ...
                    <c:forEach var="student" items="${list}">
                        <tr>
                            ...
                            <td>
                                <a class="link-update" href='adminfindStuById.do?id=${student.id}'>修改</a>
                                <a class="link-del" href='admindelectStu.do?id=${student.id}'>删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
...
<script>
    ...
    function goPage1() {
        ...
        var type=$("#queryTypeSelect").val();
        var pagenumber=1;
        location.href="afindStuPage.do?type="+type+"&pageNumber="+pagenumber+"&userSearchTxt="+userSearchTxt;
    }
    function goPage2() {
        var userSearchTxt=$("#userSearchTxt").val();
        var type=$("#queryTypeSelect").val();
        ...
        location.href="afindStuPage.do?type="+type+"&pageNumber="+pagenum+"&userSearchTxt="+userSearchTxt;
    }
    function goPage3() {
        var userSearchTxt=$("#userSearchTxt").val();
        var type=$("#queryTypeSelect").val();
        ...
        var pagenum=pageNum+1;
        location.href="afindStuPage.do?type="+type+"&userSearchTxt="+userSearchTxt+"&pageNumber="+pagenum;
    }
    function goPage4() {
        var userSearchTxt=$("#userSearchTxt").val();
        var type=$("#queryTypeSelect").val();
