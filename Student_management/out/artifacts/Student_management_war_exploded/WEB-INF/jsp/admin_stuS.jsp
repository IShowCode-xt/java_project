                ...
                <table class="result-tab" width="100%" id ="vetListTable">
                    ...
                    <c:forEach var="score" items="${list}">
                        <tr>
                            ...
                            <td>${score.russion}</td>
                            <td>
                                <a class="link-update" href='adminfindScoreByStuCard.do?stuCard=${score.stuCard}'>修改</a>
                                <a class="link-del" href='admindelectScore.do?stuCard=${score.stuCard}'>删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
...
<script >
    ...
    function st() {
        ...
        location.href="afindScore.do?type="+type+"&userSearchTxt="+userSearchTxt;
    }
    function goPage1() {
        var userSearchTxt=$("#userSearchTxt").val();
        var type=$("#queryTypeSelect").val();
        var pagenumber=1;
        location.href="afindScorePage.do?type="+type+"&pageNumber="+pagenumber+"&userSearchTxt="+userSearchTxt;
    }
    function goPage2() {
        var userSearchTxt=$("#userSearchTxt").val();
        var type=$("#queryTypeSelect").val();
        ...
        location.href="afindScorePage.do?type="+type+"&pageNumber="+pagenum+"&userSearchTxt="+userSearchTxt;
    }
    function goPage3() {
        var userSearchTxt=$("#userSearchTxt").val();
        var type=$("#queryTypeSelect").val();
        ...
        var pagenum=pageNum+1;
        location.href="afindScorePage.do?type="+type+"&userSearchTxt="+userSearchTxt+"&pageNumber="+pagenum;
    }
    function goPage4() {
        var userSearchTxt=$("#userSearchTxt").val();
        var type=$("#queryTypeSelect").val();
