...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <div class="result-content">
            <form action="updateVet" method="post" id="myform" name="myform">
                <table class="insert-tab" width="100%">
                    <tbody>
                    <tr>
                        <th><i class="require-red">*</i>姓名：</th>
                        <td>
                            <input name="vet_id" value="${vet.id}" hidden="hidden">
                            <input class="common-text required" id="vet_name" name="vet_name" value="${vet.name}" size="50"  type="text">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require-red">*</i>电话：</th>
                        <td><input class="common-text" id="vet_tel" name="vet_tel" value="${vet.tel}" size="50"  type="text"></td>
                    </tr>
                    <tr>
